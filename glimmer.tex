...
CISM development was supported primarily by the Earth System Modeling program, Office of Biological and Envi- 15 ronmental Research (BER) of the U.S. Department of Energy’s Office of Science. Additional support was provided by the DOE’s Office of Advanced Scientific Computing Research (ASCR), by BER’s Regional and Global Climate Modeling Program, and by the National Sci- ence Foundation. The National Center for Atmospheric Research is sponsored by the National Science Foundation. CISM has evolved from the Glimmer model which was supported by the U.K. National Environmental Research Council (through the Centre for Polar and Ocean Modelling).
